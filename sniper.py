...
def banner():
    ...
    runntct(".                 hargai karya ya tod ")
    runntxt(GG+"               SIAP MEMAKAI SENJATA  ")
    runntxt(GG+".        alangkah baik nya kita berdoa dulu")
    time.sleep(1.5)
    print GG+".      (¯`·.¸¸.·´¯`·.¸¸.-¯`·.¸.·´¯`·.¸¸.·.¸¸.·´¯`·.¸¸.->")
...
def pil():
                print GG+" "
                g = str(raw_input("[?] menembak lagi..\033[93;1m[y/n]: "))
                if g == 'y' or g == 'Y':
